...
\begin{document}
	...
	$3x^20-x+2=0$ % 注意此时的指数20，并没有被按照指数20处理，还是指数2，按下式处理
	...
	$a_0,a_1,a_2,...,a_100$ % 注意，此时1、2、3...100，中断了排序latex无法识别，所以必须将100至于{}内，如下
	...
	交换律是 $$a+b=b+a$$，如$$1+2=2+1=3$$ % 注意排版格式，在源码中可以直接换行便于阅读，同时可以删除“，”。
	...
	\subsection{不编号公式equation*环境} % 需要引入amsmath宏包
